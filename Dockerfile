...
RUN groupadd --gid 3434 anadsonpassos \
  && useradd --uid 3434 --gid anadsonpassos --shell /bin/bash --create-home anadsonpassos \
  && echo 'anadsonpassos ALL=NOPASSWD: ALL' >> /etc/sudoers.d/anadsonpassos \
  && echo 'Defaults    env_keep += "DEBIAN_FRONTEND"' >> /etc/sudoers.d/env_keep

USER anadsonpassos
ENV PATH /home/anadsonpassos/.local/bin:/home/anadsonpassos/bin:${PATH}
...
LABEL io.anadsonpassos.preserve-entrypoint=true
